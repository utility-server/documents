...
- Employee information (where permitted by law)
...
- Challenge the legal requirement;
- Seek protective orders or other appropriate remedies;
- Pursue legal action against the Receiving Party for breach if disclosure was avoidable.
...
Upon the earlier of:
- Completion or termination of the Purpose; or
...
- Confidential Information that cannot be returned or destroyed due to automatic backup systems, provided it remains subject to this Agreement;
- Confidential Information required to be retained by applicable law or regulation.
...
- Any license, right, title, or interest in the Confidential Information;
- Any intellectual property rights;
- Any ownership rights;
- Any right to use trademarks, patents, or copyrights.
...
- Refrain from pursuing similar opportunities with others.

### 6.2 No Representation or Warranty

The Disclosing Party makes NO representation or warranty regarding:
- Accuracy or completeness of Confidential Information;
...
- **Three (3) years** from the Effective Date; OR
...
- Monetary damages alone may be inadequate to compensate for such breach;
- The Disclosing Party is entitled to seek equitable relief.

### 8.2 Injunctive Relief

In the event of actual or threatened breach, the Disclosing Party shall be entitled to:
- Seek immediate injunctive relief without proving actual damages;
- Obtain specific performance;
- Pursue any other equitable remedies;
...
- Recovery of attorneys' fees and costs (if prevailing party).
...
- Disclosure and receipt of Confidential Information complies with export control laws;
- It will not use Confidential Information in violation of any laws.

### 9.3 Ownership

The Disclosing Party represents and warrants that:
- It has the right to disclose the Confidential Information;
- Disclosure does not violate any third-party rights;
- To its knowledge, Confidential Information does not infringe third-party intellectual property rights.
...
- Constitute either party as agent of the other;
- Grant either party authority to bind the other;
- Create any fiduciary duty between the parties.

### 10.2 No Guarantee of Transaction

This Agreement does NOT:
- Obligate either party to enter into any other agreement;
- Guarantee any business relationship will result;
- Prevent either party from pursuing similar relationships with others;
- Create any expectation of exclusivity.
...
- Upon receipt if by hand delivery;
- Upon confirmation of transmission if by email;
- Three business days after mailing if by certified mail.
...
- Each party shall comply with applicable data protection laws (GDPR, CCPA, etc.);
- Processing shall be limited to what is necessary for the Purpose;
...
## Contact for NDA-Related Questions
